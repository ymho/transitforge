...
export function travelDecoration(kind: "landscape" | "canal" | "retreat" | "rail" = "landscape"): string {
  const scene = kind === "rail" ? '<div class="scenery-rail"></div><div class="scenery-train"></div>'
