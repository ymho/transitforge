...
describe("Agent Evaluation Framework", () => {
  it("evaluates 38 reproducible cases and reuses known journey scenarios", () => {
    ...
    expect(report.passedCaseCount).toBe(38);
    ...
    expect(markdown).toContain("Cases: 38/38 passed");
