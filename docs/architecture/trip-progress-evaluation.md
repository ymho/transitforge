...
- Smoke: 保存済み12ケースの6指標＋従来A/G＋Trip Progress A/C/G/K/N/O/Qをhard gate。
- Full: 保存済み42ケース＋従来A〜G＋Trip Progress A〜Rをhard gate。M/Nは#411の既知party/年齢不明、O/Pは#413のタクシー/便未定航空、Q/Rは#400の宿採用/差し替えの進展を検証する。実モデル品質を証明するものではない。
