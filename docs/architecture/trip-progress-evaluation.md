...
- Smoke: 保存済み12ケースの6指標＋従来A/G＋Trip Progress A/C/G/K/N/Oをhard gate。
- Full: 保存済み42ケース＋従来A〜G＋Trip Progress A〜Pをhard gate。M/Nは#411の既知party/年齢不明、O/Pは#413のタクシー/便未定航空の進展を検証する。実モデル品質を証明するものではない。
