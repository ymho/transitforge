...
保存済み混雑履歴の日別・時間別・路線別・列車別分析と、列車遅延の現在・日別・時間別分析を
...
| 混雑履歴 | JST日付を指定し、日次ピーク、1時間ごとの推移、行き先側路線順位、種別・列車名・行き先付き列車順位を分析する |
| 列車遅延 | JST日付を指定し、最新状況、日次ピーク、1時間ごとの遅延傾向、種別・列車名・行き先付き列車順位を分析する |
| 天気 | 晴れ、曇り、雨、雪を変更する |
