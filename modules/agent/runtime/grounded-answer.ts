...
export function groundedAnswerRepairInstruction(error: unknown): string {
  ...
  return `検証エラー: ${reason}。外側のagent_turn_result JSONを維持し、presentation objectだけを提示されたtravel-plan schemaと実在Evidence IDで修正してください。responseTextは短いstringのままにしてください。`;
}
